...
class Network(object):
    ...
    def add_parameters(self, dropout, lstm_size, optimizer, model_type, gru = True):
        ...
        self.W_att = self.model.add_parameters((1, lstm_size * 2))
    ...
    def decode(self, states, y, train = False):
        ...
        for char in y:
            ...
            weighted_states = self.attend(s.output(), states)
    ...
    def train(self, train_data, dev_data, num_epochs = 120, batch_size = 10):
        ...
        for I in range(num_epochs):
                ...
                for i, (x,y) in enumerate(train_data):
                    ...
                    loss, probs = self.decode(encoded_state, y, train = True)
                ...
                if acc > self.best_acc:
                    self.best_acc = acc
                    self.model.save("model-gru.m."+str(self.id))
    ...
    def evaluate(self, dev_data):
        ...
        with open("preds-gru"+str(self.id)+".txt", "w") as f:
